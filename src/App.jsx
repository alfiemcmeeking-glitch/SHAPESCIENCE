...
/* âââââââââââââââââââââââââââ FILM GRAIN OVERLAY âââââââââââââââââââââââââââ */
function FilmGrain() {
  return (
    <div style={{
...
/* âââââââââââââââââââââââââââ CUSTOM CURSOR âââââââââââââââââââââââââââ */
function Cursor() {
...
/* âââââââââââââââââââââââââââ SCROLL PROGRESS âââââââââââââââââââââââââââ */
...
/* âââââââââââââââââââââââââââ HOME PAGE âââââââââââââââââââââââââââ */
      ...
      <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",padding:"120px clamp(24px,8vw,160px)"}}>
        ...
        <ScrollReveal delay={600}>
          <p className="body-text" style={{fontSize:13,lineHeight:2,opacity:0.4,maxWidth:500,marginTop:40,letterSpacing:"0.04em"}}>
            A new approach to material design â where biology meets computation, 
...
/* âââââââââââââââââââââââââââ SCROLL REVEAL âââââââââââââââââââââââââââ */
...
/* âââââââââââââââââââââââââââ ABOUT PAGE âââââââââââââââââââââââââââ */
function AboutPage() {
    ...
    <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",position:"relative",padding:"120px 24px"}}>
      ...
      <div style={{
        ...
        <p className="body-text" style={{fontSize:13,lineHeight:2,letterSpacing:"0.04em",fontWeight:300}}>
          ...
          We set the conditions â the material shapes itself.
        </p>
      </div>
    </section>
  );
...
/* âââââââââââââââââââââââââââ TECH PAGE âââââââââââââââââââââââââââ */
function TechPage() {
  return (
    <section style={{
      height:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",
...
/* âââââââââââââââââââââââââââ QUESTIONNAIRE PAGE âââââââââââââââââââââââââââ */
const QUESTIONS = [
  ...
  { category:"PROCESS", questions:[
    ...
    { id:"q4",label:"Tolerance range (mm)",type:"text",placeholder:"Â±0.00" },
        ...
        <ScrollReveal key={si} delay={si*100}>
          <div style={{marginBottom:64}}>
            <div className="body-text" style={{
              ...
              textTransform:"uppercase",
            }}>{String(si+1).padStart(2,"0")} â {section.category}</div>
...
function ContactPage() {
  ...
  const handleSubmit = () => {
    const subject = encodeURIComponent(`Shape Science â Contact from ${form.name}`);
  ...
  return (
    <>
      ...
      <footer style={{
        ...
        <span className="body-text">Shape Science Â© 2026</span>
